...
public class UtilisateurController {
    ...
    public ResponseEntity getUtilisateursByRoleTitle(@PathVariable String title) {
        List<Utilisateur> utilisateurs = utilisateurRepository.findUtilisateursByRoleTitle(title);
        if(utilisateurs.isEmpty()){
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("No Utilisateur found with this role");
        }else{
